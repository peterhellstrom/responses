...
install.missing <- function(mypkg, repos="https://ftp.acc.umu.se/mirror/CRAN/", dependencies=TRUE) {
...
pkgs <- c("MASS","fitdistrplus","fdrtool","R.utils","gamlss","gamlss.tr","bbmle","VGAM","xlsx")
