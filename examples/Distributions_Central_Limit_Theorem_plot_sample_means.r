...
# From http://www.r-bloggers.com/using-r-for-introductory-statistics-6-simulations/
...
# Test the function:
# n = size of sample
# m = number of resamplings

plot_sample_means(f_sample=rnorm, n=10, m=300, mean=0, sd=1)

plot_sample_means(f_sample=rexp, n=10, m=300, rate=1/10)

plot_sample_means(f_sample=rexp, n=30, m=300, rate=1/10)